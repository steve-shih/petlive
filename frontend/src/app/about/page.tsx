      ...
      <div className="flex-1 bg-surface border border-surface/50 rounded-2xl p-6 md:p-10 shadow-lg">
        {activeTab === 'about' && (
          <div className="space-y-6 animate-fade-in">
            ...
            <p className="leading-relaxed text-text-secondary text-lg">
              PetBar 致力於打造一個安全、透明、且充滿互動性的特殊寵物交易環境。我們深知甲蟲、爬蟲等活體動物在運送與交易過程中的痛點，因此導入了革命性的 WebRTC 直播與視訊展示系統，讓買家在下單前能 100% 確認寵物的健康狀態。
            </p>
        ...
        {activeTab === 'certification' && (
          <div className="space-y-6 animate-fade-in">
            ...
            <p className="leading-relaxed text-text-secondary text-lg">
              為了提升活體交易的品質，PetBar 推出了「認證繁殖家」制度。通過認證的賣家將獲得專屬的藍勾勾標章，並享有手續費減免與專屬曝光版面。
            </p>
